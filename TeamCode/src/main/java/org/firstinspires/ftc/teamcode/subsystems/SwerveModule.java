...
public class SwerveModule {
    public static double P = 0, I = 0, D = 0; //CONTROL PID PT MODUL SWERVE
    ...
    private AbsoluteAnalogEncoder encoder; //ENCODER SERVO
    ...
    public SwerveModule(DcMotorEx m, CRServo s, AbsoluteAnalogEncoder e) {  //DECLARAM UN MODUL CU MOTOR, SERVO SI ENCODER PT SERVO
        motor = m;
